...
.drk-bio-figure ._3d-block{position:relative;z-index:1;margin:0}
.drk-bio-img{width:100%;height:auto;aspect-ratio:7/8;object-fit:cover;object-position:top center;border-radius:1.25em;display:block;box-shadow:0 26px 55px -28px rgba(3,25,44,.55)}
.drk-bio-badge{position:absolute;left:-.6em;bottom:1.4em;z-index:2;background:var(--dark-blue);color:#fff;border-radius:.9em;padding:.7em 1.1em;display:flex;flex-direction:column;box-shadow:0 16px 30px -14px rgba(3,25,44,.5)}
.drk-bio-badge-num{font-size:1.6em;line-height:1;font-weight:700}
.drk-bio-badge-txt{font-size:.62em;letter-spacing:.12em;text-transform:uppercase;opacity:.8;margin-top:.35em}
