...
const DOC_IMG =
  "/klaas/wf/633daa121f130819bf83b08d/6349b9fb8a12a186c7739164_pexels-polina-zimmerman-4687344.avif";

const SECTION = `<section id="the-team" class="section"><div class="container"><div class="padding"><style>
.drk-bio-grid{display:grid;grid-template-columns:0.9fr 1.15fr;gap:4em;align-items:center}
.drk-bio-img{width:100%;height:100%;max-height:34em;object-fit:cover;border-radius:1em;display:block}
